...
const signinCard = document.querySelector('.res-sign-in');
const signupCard = document.querySelector('.res-sign-up');


signin.addEventListener("click", e =>{
    e.preventDefault();
    signupCard.classList.remove('active');
    if(!signinCard.classList.contains('active')){
...
signup.addEventListener("click", e =>{
    ...
    if(!signupCard.classList.contains('active')){
